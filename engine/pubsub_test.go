...
func TestPubSub_SubscribeUnsubscribe(t *testing.T) {
	...
	default:
		// This default case is tricky because a read from a closed channel can happen instantly.
		// The check `if ok` is the canonical way to test for a closed channel.
	}
}
